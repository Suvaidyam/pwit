 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _n=()=>yn().__FIREBASE_DEFAULTS__,In=()=>{if(typeof process=="undefined"||typeof Ne=="undefined")return;const t=Ne.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},vn=()=>{if(typeof document=="undefined")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch(n){return}const e=t&&wn(t[1]);return e&&JSON.parse(e)},En=()=>{try{return _n()||In()||vn()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},Qe=()=>{var t;return(t=En())===null||t===void 0?void 0:t.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Gn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Gn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ue="@firebase/app",$e="0.10.16";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=new Bn("@firebase/app"),Jn="@firebase/app-compat",Yn="@firebase/analytics-compat",Xn="@firebase/analytics",Qn="@firebase/app-check-compat",Zn="@firebase/app-check",er="@firebase/auth",tr="@firebase/auth-compat",nr="@firebase/database",rr="@firebase/data-connect",sr="@firebase/database-compat",ir="@firebase/functions",ar="@firebase/functions-compat",or="@firebase/installations",cr="@firebase/installations-compat",lr="@firebase/messaging",ur="@firebase/messaging-compat",hr="@firebase/performance",dr="@firebase/performance-compat",fr="@firebase/remote-config",pr="@firebase/remote-config-compat",gr="@firebase/storage",mr="@firebase/storage-compat",br="@firebase/firestore",wr="@firebase/vertexai",yr="@firebase/firestore-compat",_r="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F=new Map,vr=new Map,de=new Map;function Ue(t,e){try{t.container.addComponent(e)}catch(n){I.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function O(t){const e=t.name;if(de.has(e))return I.debug(`There were multiple attempts to register component ${e}.`),!1;de.set(e,t);for(const n of F.values())Ue(n,t);for(const n of vr.values())Ue(n,t);return!0}function ge(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lr(t){O(new T("platform-logger",e=>new zn(e),"PRIVATE")),O(new T("heartbeat",e=>new Or(e),"PRIVATE")),D(ue,$e,t),D(ue,$e,"esm2017"),D("fire-js","")}Lr("");var Pr="firebase",Br="11.0.2";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */D(Pr,Br,"app");const ot="@firebase/installations",me="0.6.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ye(t,e=!1){return c(this,null,function*(){let n;const r=yield G(t.appConfig,i=>{if(!Et(i))throw k.create("not-registered");const a=i.authToken;if(!e&&us(a))return i;if(a.requestStatus===1)return n=cs(t,e),i;{if(!navigator.onLine)throw k.create("app-offline");const o=ds(i);return n=ls(t,o),o}});return n?yield n:r.authToken})}function cs(t,e){return c(this,null,function*(){let n=yield Ke(t.appConfig);for(;n.authToken.requestStatus===1;)yield bt(100),n=yield Ke(t.appConfig);const r=n.authToken;return r.requestStatus===0?ye(t,e):r})}function Ke(t){return G(t,e=>{if(!Et(e))throw k.create("not-registered");const n=e.authToken;return fs(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}function ls(t,e){return c(this,null,function*(){try{const n=yield as(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return yield j(t.appConfig,r),n}catch(n){if(ht(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))yield It(t.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});yield j(t.appConfig,r)}throw n}})}function Et(t){return t!==void 0&&t.registrationStatus===2}function us(t){return t.requestStatus===2&&!hs(t)}function hs(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+Ur}function ds(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function fs(t){return t.requestStatus===1&&t.requestTime+ct<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ds="firebase-messaging-database",Os=1,A="firebase-messaging-store";let ie=null;function _e(){return ie||(ie=q(Ds,Os,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(A)}}})),ie}function Ie(t){return c(this,null,function*(){const e=Ee(t),r=yield(yield _e()).transaction(A).objectStore(A).get(e);if(r)return r;{const s=yield Rs(t.appConfig.senderId);if(s)return yield ve(t,s),s}})}function ve(t,e){return c(this,null,function*(){const n=Ee(t),s=(yield _e()).transaction(A,"readwrite");return yield s.objectStore(A).put(e,n),yield s.done,e})}function Ns(t){return c(this,null,function*(){const e=Ee(t),r=(yield _e()).transaction(A,"readwrite");yield r.objectStore(A).delete(e),yield r.done})}function Ee({appConfig:t}){return t.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
