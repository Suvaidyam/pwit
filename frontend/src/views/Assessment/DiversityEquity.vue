<template>
    <div class="pt-2 w-full h-full">
        <div class="w-full pt-1 h-full">
            <div class="relative h-full inline-block text-buttom w-full">
                                ...
                                <div class=" ">
                                    ...
                                    <div class="text-justify text-sm text-trbase font-normal pt-2">
                                        ...
                                        <Popper :arrow="true" :zIndex="20" :offsetDistance="4" placement="bottom-start">
                                            ...
                                            <template #content>
                                                <div class=" shadow-lg rounded-md bg-[#255B97] text-white p-3 py-2">
                                                    <a target="_blank"
                                ...
                                <div class=" ">
                                    <div class="flex gap-3  text-h5 text-sebase font-bold font-primary pb-2"> Why is DEI
                                        ...
                                        <Popper :arrow="true" :zIndex="20" :offsetDistance="0" placement="bottom-start">
                                            ...
                                            <template #content>
                                                <div
                                                    class=" md:w-[400px] shadow-lg rounded-md bg-[#255B97] text-white p-3 py-2">
                                                    <p class="text-sm font-medium">Whilst the self-assessment tool
                                                        ...
                                                        DEI can
                                                        be found at the bottom section of this page.</p>
                                                </div>
                                            </template>
                                        </Popper>
                                    </div>
                            ...
                            <div class="pt-5">
                                ...
                                <div class="pl-[44px]">
                                    ...
                                    <ul class="pl-4 list-disc text-sm text-trbase">
                                        ...
                                        <li>“<a class="text-blue-600 hover:underline"  href="https://www.abfe.org/resources/case-study-who-manages-money-how-foundations-should-help-democratize-capital" target="_blank">Case Study: Who Manages The Money? How Foundations Should Help Democratize Capital,</a>” ABFE, 
                                            October 2014.</li>
                                        <li><a class="text-blue-600 hover:underline"  href="https://changephilanthropy.org/resource-hub/" target="_blank">Resource Hub,</a> Change Philanthropy, 2023.</li> 
                                    </ul>
                                </div>
                                <!-- second -->
                                <div class="pl-[44px] pt-3">
                                    ...
                                    <ul class="pl-4 list-disc text-sm text-trbase">
                                        ...
                                        <li><a class="text-blue-600 hover:underline"  href="https://ciff.org/wp-content/uploads/2024/01/CIFF-Equity-Toolkit.pdf" target="_blank">Equity Toolkit,</a> Children’s Investment Fund Foundation.</li> 
                                        <li><a class="text-blue-600 hover:underline"  href="https://docs.gatesfoundation.org/documents/bill_and_melinda_gates_foundation_2022_dei_progress_report.pdf" target="_blank">DEI Progress Report 2022,</a> Bill & Melinda Gates Foundation.</li> 
                                ...
                                <div class="pl-[44px] pt-3">
                                    ...
                                    <ul class="pl-4 list-disc text-sm text-trbase">
                                        ...
                                        <li>“<a class="text-blue-600 hover:underline"  href="https://socapglobal.com/2023/02/how-partnerships-can-advance-innovative-approaches-to-dei/" target="_blank">How Partnerships Can Advance Innovative Approaches to DEI,</a> ” SOCAP Digital. </li> 
                                    </ul>
                                </div>
                            </div>
                        </div>
